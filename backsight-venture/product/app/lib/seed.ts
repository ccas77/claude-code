...
// --- PLSS section geometry (approximate, for realistic scatter) --------------
...
/** Center lat/lng of a section, honoring serpentine section numbering. */
export function sectionCenter(
  ...
  // Section 1 is the NE corner; numbering snakes west then east.
